    ...
    <>
      ...
      <section className="relative overflow-hidden bg-cream pb-16 pt-16 sm:pb-20 sm:pt-20 lg:pb-24 lg:pt-24">
        <div aria-hidden className="pointer-events-none absolute inset-0">
          <div className="absolute -right-28 -top-24 h-[440px] w-[440px] rounded-full bg-cmyk-pink/8 blur-[130px]" />
          <div className="absolute -left-32 bottom-0 h-[380px] w-[380px] rounded-full bg-cmyk-cyan/12 blur-[120px]" />
        </div>
        ...
        <div className="shell relative">
          ...
          <Reveal delay={0.06}>
            <h1 className="mt-5 max-w-[19ch] font-display text-[clamp(30px,5.2vw,60px)] font-extrabold leading-[1.04] tracking-[-0.03em] text-ink sm:mt-6">
              {about.title}
            </h1>
          </Reveal>
            ...
            <Reveal delay={0.14}>
              <div className="relative aspect-square overflow-hidden border border-line bg-paper-soft">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "radial-gradient(60% 60% at 30% 25%, rgba(230,0,126,0.09), transparent 70%), radial-gradient(55% 55% at 78% 76%, rgba(76,184,224,0.12), transparent 70%)",
                  }}
                />
      ...
      <section className="bg-gradient-to-b from-paper to-paper-soft py-16 sm:py-20 lg:py-24">
        <div className="shell">
          <Reveal>
              ...
              {about.geography.map((item, i) => (
                <Reveal as="li" key={item.title} delay={0.05 * i}>
                  <div className="border-b border-line py-5 sm:py-6">
                    <h3 className="font-display text-[16px] font-bold tracking-[-0.015em] text-ink sm:text-[17px]">
                      {item.title}
                    </h3>
              ...
              {about.audience.map((item, i) => (
                <Reveal as="li" key={item.title} delay={0.05 * i}>
                  <div className="flex items-start gap-4 border-b border-line py-5 sm:py-6">
                    <span className="mt-[3px] font-display text-[12px] font-bold tracking-[0.06em] text-cmyk-pink">
      ...
      <section className="bg-paper py-16 sm:py-20">
        <div className="shell flex flex-col items-start gap-6 border-t border-line pt-12 sm:flex-row sm:items-center sm:justify-between sm:pt-14">
          <p className="max-w-[42ch] font-display text-[19px] font-extrabold leading-[1.25] tracking-[-0.025em] text-ink sm:text-[22px]">
