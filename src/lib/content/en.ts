    ...
    items: [
      {
        key: "roll",
        src: "",
        alt: "Rolls of printed film in the warehouse",
        caption: "Printed rolls: 250–550 mm wide, up to 3,000 m per roll.",
      },
      {
        key: "tray",
        src: "",
        alt: "A finished tray wrapped in printed film on a store shelf",
        caption: "A finished tray with your brand — this is how the product looks on the shelf.",
      },
      {
        key: "raster",
        src: "",
        alt: "Halftone image on 12 µm film",
        caption: "Halftone on 12 µm film: gradients and small type stay crisp.",
      },
    ],
  },
