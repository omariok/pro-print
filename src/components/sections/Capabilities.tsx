        ...
        <Reveal delay={0.1}>
          <div className="mt-12 grid gap-px overflow-hidden rounded-panel bg-ink/10 ring-1 ring-ink/10 sm:mt-14 sm:grid-cols-2 lg:mt-16 lg:grid-cols-3">
            {capabilities.cards.map((card) => (
              <article
                key={card.title}
                className="group flex flex-col bg-card p-7 transition-colors duration-200 hover:bg-paper sm:p-8 lg:p-9"
              >
            ...
            <article className="flex flex-col bg-card p-7 transition-colors duration-200 hover:bg-paper sm:col-span-2 sm:p-8 lg:p-9">
              <h3 className="h-card text-ink">{capabilities.prepress.title}</h3>
