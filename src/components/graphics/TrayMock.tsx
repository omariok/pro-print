    ...
    <svg viewBox="0 0 420 260" className={className} role="presentation" aria-hidden="true">
      <defs>
        <filter id="tray-shadow" x="-20%" y="-20%" width="140%" height="150%">
          <feDropShadow dx="0" dy="10" stdDeviation="14" floodColor="#233038" floodOpacity="0.09" />
        </filter>
      </defs>
      ...
      <g filter="url(#tray-shadow)">
        ...
        <path
          ...
          fill="var(--color-sea)"
        />
        <rect x="66" y="122" width="184" height="11" rx="5.5" fill="#3a4a54" />
        <rect x="66" y="152" width="128" height="11" rx="5.5" fill="#c5ced1" />
        <rect x="66" y="182" width="86" height="11" rx="5.5" fill="var(--color-sand)" />
        <circle cx="326" cy="176" r="27" fill="var(--color-accent)" />
      </g>
    </svg>
  );
}
